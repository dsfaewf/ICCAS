...
public class MinigameDescriptionSamepictureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_minigame_description_samepicture);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MinigameDescriptionSamepictureActivity.this, ServeGame_samepicture.class);
                startActivity(intent);
                finish();
            }
        });
