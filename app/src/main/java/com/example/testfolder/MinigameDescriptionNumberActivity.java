...
public class MinigameDescriptionNumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_minigame_description_number);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MinigameDescriptionNumberActivity.this, ServeGame_NumberActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void loadDescriptionVideo() {
        try {
            // 동영상 파일 경로 설정
            String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.updown_game;
