...
import com.katzheimer.testfolder.Diary_write_UI.Companion.PROB_TYPE_BLANK
import com.katzheimer.testfolder.Diary_write_UI.Companion.PROB_TYPE_MCQ
import com.katzheimer.testfolder.Diary_write_UI.Companion.PROB_TYPE_OX
import com.katzheimer.testfolder.utils.LoadingAnimation
import com.katzheimer.testfolder.utils.OpenAI
import com.katzheimer.testfolder.utils.PreprocessTexts
import com.katzheimer.testfolder.viewmodels.OpenAIViewModel
import com.katzheimer.testfolder.viewmodels.DiaryWriteViewModel
...
class DiaryDetailActivity : com.katzheimer.testfolder.BaseActivity() {
...
//            firebaseViewModel.allQuizSaved.removeObservers(this)
        ...
        saveButton.setOnClickListener {
            ...
            if (currentTime - lastClickTime >= interval) {
                ...
                if (round(this.numOfQuestions/1.5).toInt() < 2){
                    mediafail.start()
